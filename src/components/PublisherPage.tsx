...
interface PublisherPageProps {
  ...
  searchParams: { page?: string; genre_filter?: string; language_filter?: string; min_price?: string; max_price?: string; sort_by?: string; sort_order?: string };
}

export const PublisherPage = async ({ publisherSlug, searchParams }: PublisherPageProps) => {
  ...
  const filterParams = {
    publisher_filter: publisherSlug,
    genre_filter: searchParams.genre_filter || undefined,
      ...
      <section className="py-8 px-4 text-center bg-gray-50 border-b border-gray-200">
        <div className="container mx-auto">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-2 text-gray-900">{publisherSlug} Books</h1>
          </div>
          <p className="text-lg text-gray-600 mb-4">Browse all books published by {publisherSlug}.</p>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    name="genre_filter"
                    placeholder="Genre..."
                    defaultValue={searchParams.genre_filter || ''}
                  />
                </div>
                <div>
        ...
        {totalPages > 1 && (
          <div className="mt-8">
            <ClientPagination
              ...
              baseUrl={`/publisher/${encodeURIComponent(publisherSlug)}`}
            />
          </div>
        )}
        ...
        {books.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-lg text-muted-foreground">
              No books found by {publisherSlug}
            </p>
          </div>
        )}
      </div>
