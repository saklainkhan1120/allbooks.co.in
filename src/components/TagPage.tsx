...
export const TagPage = async ({ tagSlug, searchParams }: TagPageProps) => {
      ...
      <section className="py-8 px-4 text-center bg-gray-50 border-b border-gray-200">
        <div className="container mx-auto">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-2 text-gray-900">{tagSlug} Books</h1>
          </div>
          <p className="text-lg text-gray-600 mb-4">Browse all books tagged with {tagSlug}.</p>
        </div>
      </section>
        ...
        {totalPages > 1 && (
          <div className="mt-8">
            <ClientPagination
              ...
              baseUrl={`/tag/${encodeURIComponent(tagSlug)}`}
            />
          </div>
        )}
        ...
        {books.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-lg text-muted-foreground">
              No books found with tag {tagSlug}
            </p>
          </div>
        )}
      </div>
